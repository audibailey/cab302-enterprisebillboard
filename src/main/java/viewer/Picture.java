...
public class Picture extends JLabel {
    ...
    public Picture(Billboard billboard, Container container) throws IOException {
        // Check if picture byte array is not empty and information and message are empty
        if (billboard.picture != null && billboard.information == null && billboard.message == null){
            ...
            int labelWidth = (Toolkit.getDefaultToolkit().getScreenSize().width / 2); // Storing the width of the label as 50% of screen width
